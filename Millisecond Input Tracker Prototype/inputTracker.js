let trackerSketch = function(p) {
  ...
  p.preload = function() {
    ...
    hit = loadSound('https://src-img.github.io/deltaTeam/millisecondTracker/click.wav');
    result = loadSound('https://src-img.github.io/deltaTeam/millisecondTracker/pickupCoin.wav');
  }
  ...
  p.draw = function() {
    ...
    p.rect(50, 65, 200, 50);
    p.text(round(performance.now()) + "ms", 55, 100);
  }
...
new p5(trackerSketch, 'trackerContainer');
